    ...
    <div className="flex justify-center items-center py-12">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Phone8ez 계정에 로그인하여 모든 서비스를 이용하세요.</CardDescription>
        </CardHeader>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" passHref>
                <Button variant="link" className="px-0 text-sm h-auto text-primary">비밀번호를 잊으셨나요?</Button>
              </Link>
            </div>
        ...
        <CardFooter className="flex flex-col items-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <Link href="/signup" passHref>
              <Button variant="link" className="px-0 text-sm h-auto text-primary">회원가입</Button>
            </Link>
          </p>
        </CardFooter>
      </Card>
