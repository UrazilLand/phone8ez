  ...
  return (
    <div className="space-y-12">
      <section className="text-center py-12 bg-card rounded-lg shadow-md">
        <h1 className="text-3xl md:text-4xl font-suit font-bold text-primary mb-4">휴대폰 판매 데이터를 가장 쉽게 다루는 방법</h1>
      ...
      <section>
        <h2 className="text-3xl font-suit font-semibold text-center text-primary mb-8">왜 Phone8ez를 선택해야 할까요?</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Card className="text-center shadow-lg hover:shadow-xl transition-shadow bg-card">
            <CardHeader>
              <BarChartBig className="h-12 w-12 mx-auto text-primary mb-2" />
              <CardTitle className="font-suit text-xl text-primary">정책표 자동 정리</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="text-center shadow-lg hover:shadow-xl transition-shadow bg-card">
            <CardHeader>
              ...
              <CardTitle className="font-suit text-xl text-primary">직관적인 시각화</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="text-center shadow-lg hover:shadow-xl transition-shadow bg-card">
            <CardHeader>
              <MessageSquareHeart className="h-12 w-12 mx-auto text-primary mb-2" />
              <CardTitle className="font-suit text-xl text-primary">클라우드 백업 & 복원</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="text-center shadow-lg hover:shadow-xl transition-shadow bg-card">
            <CardHeader>
              ...
              <CardTitle className="font-suit text-xl text-primary">현장 피드백 기반 개선</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <section className="bg-card p-8 rounded-lg shadow-md">
          <h2 className="text-3xl font-suit font-semibold text-center text-primary mb-8">Phone8ez가 지키는 핵심 가치</h2>
